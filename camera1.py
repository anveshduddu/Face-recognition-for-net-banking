...
from face import isBlinking, detect_and_display, process_and_encode, init
...
class VideoCamera(object):
    ...
    def detect_and_display( model, video_capture, face_detector, open_eyes_detector, left_eye_detector,
                           right_eye_detector,
                           data, eyes_detected):
